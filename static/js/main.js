...
function autoFlipCards() {
  ...
  meghaCardInner.style.transform =
    meghaCardInner.style.transform === "rotateY(180deg)"
      ? "rotateY(0deg)"
      : "rotateY(180deg)";

  // Toggle the transform property for Aryavardhan's profile
  const aryavardhanCardInner =
    aryavardhanProfile.querySelector(".flip-card-inner-1");
  aryavardhanCardInner.style.transform =
    aryavardhanCardInner.style.transform === "rotateY(180deg)"
      ? "rotateY(0deg)"
      : "rotateY(180deg)";
}

// Set an interval to trigger the flip every 5 seconds (5000 milliseconds)
setInterval(autoFlipCards, 2000);
...
const doughnutCanvas1 = document
...
const doughnutCanvas2 = document
...
const doughnutCanvas3 = document
...
const doughnutData4 = {
  labels: [
    "Child Population of India",
    "Children with mental disorders",
    "Children not seeking support",
  ],
  datasets: [
    {
...
const doughnutCanvas4 = document
  .getElementById("doughnutChart4")
  .getContext("2d");
